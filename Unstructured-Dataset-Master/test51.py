...
# Initialize NLTK components (download required resources if not already downloaded)
import nltk
...
# Step 4: Keyword-Based Categorization and Subcategorization
...
# Step 6: KNN-Based Categorization and Subcategorization
