...
categories = {
    ...
    # Financial Crimes
    "Financial Crimes": {
        "keywords": ["investment scam", "job fraud", "tech support", "romance scam", "impersonation", "sim swap", "sextortion", "aeps fraud", "identity theft", "courier scam", "phishing", "shopping fraud", "advance fee", "real estate fraud"],
        "subcategories": {
            ...
            "Aadhaar-enabled Payment System (AePS) Fraud": ["aeps fraud", "aadhaar fraud"],
            "Identity Theft/Cloning": ["identity theft", "cloning"],
            "Courier/Parcel Scam": ["courier scam", "parcel fraud"],
            "Phishing": ["phish", "email fraud", "spoof"],
            "Online Shopping/E-commerce Frauds": ["online shopping fraud", "ecommerce scam"],
            "Advance Fee Fraud": ["advance fee", "upfront payment"],
            "Real Estate/Rental Payment Fraud": ["real estate fraud", "rental scam"]
        }
    },
    ...
    # Other Cyber Crimes
    "Other Cyber Crimes": {
        "keywords": ["fake profile", "phishing", "cyber terror", "social media hack", "gambling", "email compromise", "provocative speech", "matrimonial scam", "fake news", "cyber stalking", "defamation", "cyber pornography", "obscene", "ipr theft", "human trafficking", "blackmail", "piracy", "spoof", "cyber slavery"],
        "subcategories": {
